...
I am a passionate **Backend Developer** with expertise in **Python & Django**.  
...
🚀 **Tech Stack:** Django | Django REST Framework | PostgreSQL | Redis | Celery | Docker | Nginx | Gunicorn  
